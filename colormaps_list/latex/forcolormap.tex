...
\fancyhead[L]{\includesvg[inkscapelatex=false,height=0.9cm]{../../logo/logo_forcolormap-roma_8.svg}}
\fancyhead[C]{
	\centering
...
\begin{titlepage}
	\centering
	\includesvg[inkscapelatex=false,height=2.3cm]{../../logo/logo_forcolormap-roma_8.svg}\\
	\vspace{1cm}
